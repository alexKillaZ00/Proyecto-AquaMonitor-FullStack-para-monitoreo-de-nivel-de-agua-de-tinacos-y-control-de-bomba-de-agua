...
public class EmailService {
    ...
    public void sendPasswordResetEmail(String to, String token) {
        // La URL de tu frontend para la página de reseteo, si se sirve desde static, usar localhost
        String resetUrlLocal = apiProtocol + "://" + apiHost + ":" + apiPort + "/reset-password.html?token=" + token;
    ...
    public void sendEmailVerification(String email, String token) {
        String verificationUrl = apiProtocol + "://" + apiHost + ":" + apiPort + "/verify-email.html?token=" + token;
